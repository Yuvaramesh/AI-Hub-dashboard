 ...
 * @description: Background Paths (Customized for 10QBIT AI Hub Dashboard)
 * @version: 1.1.0
 */
  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      >
        ...
        <defs>
          {/* 💚 Green gradient version */}
          <linearGradient id="sharedGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="rgba(0, 255, 128, 0.5)" />
            <stop offset="50%" stopColor="rgba(0, 200, 100, 0.6)" />
            <stop offset="100%" stopColor="rgba(0, 150, 70, 0.4)" />
          </linearGradient>
        </defs>
...
const AnimatedTitle = memo(function AnimatedTitle({
  ...
  return (
    <motion.h1
      className="text-3xl sm:text-5xl md:text-5xl font-bold mb-8 tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-green-600"
